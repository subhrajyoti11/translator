...
const TranslateTextInputSchema = z.object({
  ...
  sourceLanguage: z.enum(['Nepali', 'Sinhalese']).describe('The language of the text to translate.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a translation expert. Translate the following text from {{sourceLanguage}} to English.\n\nText: {{{text}}}`,
});
